...
TODO
TODO: Think about TDD.
TODO: Create PokerAlgo project to hold the PokerAlgo code. This way I can separate testing and execution from the cor PokerAlgo code.
...
* Changes
* Computed preflop data, 100k simulations per hand for 1-4 opponents; the numbers look accurate, need to cross reference to make sure.
* Restructured folders, renamed the program project to PokerAlgo.Testing, and made the PokerAlgo folder its own class lib project.
* 
*/